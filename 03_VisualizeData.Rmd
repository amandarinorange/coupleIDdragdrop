...
emergence.hist <- ggplot(full, aes(emergence.perc)) + 
  geom_histogram(binwidth = 4,
                 ...
                 fill="red",
                 alpha = .1)+
  labs(title="Histogram of Emergence (Couple-Level Trait Differing From Individual-Level Traits)")+
  labs(x="Percent of Traits Rated as Emergent", y="Frequency")
...
stargazer(d, 
          summary = F,
          title = "Descriptive Statistics for Frequencies of Each Trait Rating Combination \nBased on Bootstrap Resampling", 
          type = "html", 
          out="/Users/Amanda/Desktop/PS239T/PS239T/ps239T-final-project/Results/FreqTable_ThreeFreqsBoot.html")
```
...
CIplot <- ggplot() + 
  ...
  ggtitle("Confidence Intervals Based on Bootstrap Resampling")+
